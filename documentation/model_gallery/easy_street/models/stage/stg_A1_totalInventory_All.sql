...
-- Generated at 2024-07-22 18:13:44.538449+00:00
WITH 
"A1_totalInventory_All_renamed" AS (
    ...
    FROM "memory"."main"."A1_totalInventory_All"
),

"A1_totalInventory_All_renamed_casted" AS (
    -- Column Type Casting: 
    -- date_2014_10: from INT to DECIMAL
    -- date_2014_11: from INT to DECIMAL
    -- date_2014_12: from INT to DECIMAL
    -- date_2015_01: from INT to DECIMAL
    -- date_2015_02: from INT to DECIMAL
    -- date_2015_03: from INT to DECIMAL
    -- date_2015_04: from INT to DECIMAL
    -- date_2015_05: from INT to DECIMAL
    -- date_2015_06: from INT to DECIMAL
    -- date_2015_07: from INT to DECIMAL
    -- date_2015_08: from INT to DECIMAL
    -- date_2015_09: from INT to DECIMAL
    -- date_2015_10: from INT to DECIMAL
    -- date_2015_11: from INT to DECIMAL
    -- date_2015_12: from INT to DECIMAL
    -- date_2016_01: from INT to DECIMAL
    -- date_2016_02: from INT to DECIMAL
    -- date_2016_03: from INT to DECIMAL
    -- date_2016_04: from INT to DECIMAL
    -- date_2016_05: from INT to DECIMAL
    -- date_2016_06: from INT to DECIMAL
    -- date_2016_07: from INT to DECIMAL
    -- date_2016_08: from INT to DECIMAL
    -- date_2016_09: from INT to DECIMAL
    -- date_2016_10: from INT to DECIMAL
    -- date_2016_11: from INT to DECIMAL
    -- date_2016_12: from INT to DECIMAL
    -- date_2017_01: from INT to DECIMAL
    -- date_2017_02: from INT to DECIMAL
    -- date_2017_03: from INT to DECIMAL
    SELECT
        "Area",
        "Borough",
        "AreaType",
        ...
        "date_2018_08",
        "date_2018_09",
        CAST("date_2014_10" AS DECIMAL) 
        AS "date_2014_10",
        CAST("date_2014_11" AS DECIMAL) 
        AS "date_2014_11",
        CAST("date_2014_12" AS DECIMAL) 
        AS "date_2014_12",
        CAST("date_2015_01" AS DECIMAL) 
        AS "date_2015_01",
        CAST("date_2015_02" AS DECIMAL) 
        AS "date_2015_02",
        CAST("date_2015_03" AS DECIMAL) 
        AS "date_2015_03",
        CAST("date_2015_04" AS DECIMAL) 
        AS "date_2015_04",
        CAST("date_2015_05" AS DECIMAL) 
        AS "date_2015_05",
        CAST("date_2015_06" AS DECIMAL) 
        AS "date_2015_06",
        CAST("date_2015_07" AS DECIMAL) 
        AS "date_2015_07",
        CAST("date_2015_08" AS DECIMAL) 
        AS "date_2015_08",
        CAST("date_2015_09" AS DECIMAL) 
        AS "date_2015_09",
        CAST("date_2015_10" AS DECIMAL) 
        AS "date_2015_10",
        CAST("date_2015_11" AS DECIMAL) 
        AS "date_2015_11",
        CAST("date_2015_12" AS DECIMAL) 
        AS "date_2015_12",
        CAST("date_2016_01" AS DECIMAL) 
        AS "date_2016_01",
        CAST("date_2016_02" AS DECIMAL) 
        AS "date_2016_02",
        CAST("date_2016_03" AS DECIMAL) 
        AS "date_2016_03",
        CAST("date_2016_04" AS DECIMAL) 
        AS "date_2016_04",
        CAST("date_2016_05" AS DECIMAL) 
        AS "date_2016_05",
        CAST("date_2016_06" AS DECIMAL) 
        AS "date_2016_06",
        CAST("date_2016_07" AS DECIMAL) 
        AS "date_2016_07",
        CAST("date_2016_08" AS DECIMAL) 
        AS "date_2016_08",
        CAST("date_2016_09" AS DECIMAL) 
        AS "date_2016_09",
        CAST("date_2016_10" AS DECIMAL) 
        AS "date_2016_10",
        CAST("date_2016_11" AS DECIMAL) 
        AS "date_2016_11",
        CAST("date_2016_12" AS DECIMAL) 
        AS "date_2016_12",
        CAST("date_2017_01" AS DECIMAL) 
        AS "date_2017_01",
        CAST("date_2017_02" AS DECIMAL) 
        AS "date_2017_02",
        CAST("date_2017_03" AS DECIMAL) 
        AS "date_2017_03"
    FROM "A1_totalInventory_All_renamed"
)

-- COCOON BLOCK END
SELECT *
FROM "A1_totalInventory_All_renamed_casted"