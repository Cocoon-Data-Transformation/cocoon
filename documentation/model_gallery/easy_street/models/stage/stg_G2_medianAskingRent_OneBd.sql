...
-- Generated at 2024-07-22 18:18:56.724345+00:00
WITH 
"G2_medianAskingRent_OneBd_renamed" AS (
    ...
    FROM "memory"."main"."G2_medianAskingRent_OneBd"
)

-- COCOON BLOCK END
SELECT *
FROM "G2_medianAskingRent_OneBd_renamed"