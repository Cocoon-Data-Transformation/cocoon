...
-- Generated at 2024-07-22 18:14:44.006006+00:00
WITH 
"B1_totalInventory_Condo_renamed" AS (
    ...
    FROM "memory"."main"."B1_totalInventory_Condo"
)

-- COCOON BLOCK END
SELECT *
FROM "B1_totalInventory_Condo_renamed"