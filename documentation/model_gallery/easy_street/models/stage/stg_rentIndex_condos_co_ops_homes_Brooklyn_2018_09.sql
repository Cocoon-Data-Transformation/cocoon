...
-- Generated at 2024-07-22 18:21:04.087306+00:00
WITH 
"rentIndex_condos_co_ops_homes_Brooklyn_2018_09_renamed" AS (
    ...
    FROM "memory"."main"."rentIndex_condos_co_ops_homes_Brooklyn_2018_09"
),

"rentIndex_condos_co_ops_homes_Brooklyn_2018_09_renamed_casted" AS (
    -- Column Type Casting: 
    ...
    SELECT
        ...
        CAST("date_" AS DATE) 
        AS "date_"
    FROM "rentIndex_condos_co_ops_homes_Brooklyn_2018_09_renamed"
)

-- COCOON BLOCK END
SELECT *
FROM "rentIndex_condos_co_ops_homes_Brooklyn_2018_09_renamed_casted"