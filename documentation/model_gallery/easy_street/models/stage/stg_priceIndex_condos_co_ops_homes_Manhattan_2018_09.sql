...
-- Generated at 2024-07-22 18:20:47.589702+00:00
WITH 
"priceIndex_condos_co_ops_homes_Manhattan_2018_09_renamed" AS (
    ...
    FROM "memory"."main"."priceIndex_condos_co_ops_homes_Manhattan_2018_09"
),

"priceIndex_condos_co_ops_homes_Manhattan_2018_09_renamed_casted" AS (
    -- Column Type Casting: 
    ...
    SELECT
        ...
        CAST("date_" AS DATE) 
        AS "date_"
    FROM "priceIndex_condos_co_ops_homes_Manhattan_2018_09_renamed"
)

-- COCOON BLOCK END
SELECT *
FROM "priceIndex_condos_co_ops_homes_Manhattan_2018_09_renamed_casted"