...
-- Generated at 2024-07-22 18:17:12.544332+00:00
WITH 
"D5_recordedSalesVolume_Sfr_renamed" AS (
    ...
    FROM "memory"."main"."D5_recordedSalesVolume_Sfr"
),

"D5_recordedSalesVolume_Sfr_renamed_casted" AS (
    -- Column Type Casting: 
    -- date_2012_04: from DECIMAL to INT
    -- date_2012_05: from DECIMAL to INT
    -- date_2012_06: from DECIMAL to INT
    -- date_2012_07: from DECIMAL to INT
    -- date_2012_08: from DECIMAL to INT
    -- date_2012_09: from DECIMAL to INT
    -- date_2012_10: from DECIMAL to INT
    -- date_2012_11: from DECIMAL to INT
    -- date_2012_12: from DECIMAL to INT
    -- date_2013_01: from DECIMAL to INT
    -- date_2013_02: from DECIMAL to INT
    -- date_2013_03: from DECIMAL to INT
    -- date_2013_04: from DECIMAL to INT
    -- date_2013_05: from DECIMAL to INT
    -- date_2013_06: from DECIMAL to INT
    -- date_2013_07: from DECIMAL to INT
    -- date_2013_08: from DECIMAL to INT
    -- date_2013_09: from DECIMAL to INT
    -- date_2013_10: from DECIMAL to INT
    -- date_2013_11: from DECIMAL to INT
    -- date_2013_12: from DECIMAL to INT
    -- date_2014_01: from DECIMAL to INT
    -- date_2014_02: from DECIMAL to INT
    -- date_2014_03: from DECIMAL to INT
    -- date_2014_04: from DECIMAL to INT
    -- date_2014_05: from DECIMAL to INT
    -- date_2014_06: from DECIMAL to INT
    -- date_2014_07: from DECIMAL to INT
    -- date_2014_08: from DECIMAL to INT
    -- date_2014_09: from DECIMAL to INT
    SELECT
        "Area",
        "Borough",
        "AreaType",
        ...
        "date_2018_08",
        "date_2018_09",
        CAST("date_2012_04" AS INT) 
        AS "date_2012_04",
        CAST("date_2012_05" AS INT) 
        AS "date_2012_05",
        CAST("date_2012_06" AS INT) 
        AS "date_2012_06",
        CAST("date_2012_07" AS INT) 
        AS "date_2012_07",
        CAST("date_2012_08" AS INT) 
        AS "date_2012_08",
        CAST("date_2012_09" AS INT) 
        AS "date_2012_09",
        CAST("date_2012_10" AS INT) 
        AS "date_2012_10",
        CAST("date_2012_11" AS INT) 
        AS "date_2012_11",
        CAST("date_2012_12" AS INT) 
        AS "date_2012_12",
        CAST("date_2013_01" AS INT) 
        AS "date_2013_01",
        CAST("date_2013_02" AS INT) 
        AS "date_2013_02",
        CAST("date_2013_03" AS INT) 
        AS "date_2013_03",
        CAST("date_2013_04" AS INT) 
        AS "date_2013_04",
        CAST("date_2013_05" AS INT) 
        AS "date_2013_05",
        CAST("date_2013_06" AS INT) 
        AS "date_2013_06",
        CAST("date_2013_07" AS INT) 
        AS "date_2013_07",
        CAST("date_2013_08" AS INT) 
        AS "date_2013_08",
        CAST("date_2013_09" AS INT) 
        AS "date_2013_09",
        CAST("date_2013_10" AS INT) 
        AS "date_2013_10",
        CAST("date_2013_11" AS INT) 
        AS "date_2013_11",
        CAST("date_2013_12" AS INT) 
        AS "date_2013_12",
        CAST("date_2014_01" AS INT) 
        AS "date_2014_01",
        CAST("date_2014_02" AS INT) 
        AS "date_2014_02",
        CAST("date_2014_03" AS INT) 
        AS "date_2014_03",
        CAST("date_2014_04" AS INTEGER) 
        AS "date_2014_04",
        CAST("date_2014_05" AS INT) 
        AS "date_2014_05",
        CAST("date_2014_06" AS INT) 
        AS "date_2014_06",
        CAST("date_2014_07" AS INT) 
        AS "date_2014_07",
        CAST("date_2014_08" AS INT) 
        AS "date_2014_08",
        CAST("date_2014_09" AS INT) 
        AS "date_2014_09"
    FROM "D5_recordedSalesVolume_Sfr_renamed"
)

-- COCOON BLOCK END
SELECT *
FROM "D5_recordedSalesVolume_Sfr_renamed_casted"