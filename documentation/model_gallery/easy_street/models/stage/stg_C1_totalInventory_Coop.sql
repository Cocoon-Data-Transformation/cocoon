...
-- Generated at 2024-07-22 18:15:49.279172+00:00
WITH 
"C1_totalInventory_Coop_renamed" AS (
    ...
    FROM "memory"."main"."C1_totalInventory_Coop"
),

"C1_totalInventory_Coop_renamed_casted" AS (
    -- Column Type Casting: 
    -- date_2017_04: from DECIMAL to INT
    -- date_2017_05: from DECIMAL to INT
    -- date_2017_06: from DECIMAL to INT
    -- date_2017_07: from DECIMAL to INT
    -- date_2017_08: from DECIMAL to INT
    -- date_2017_09: from DECIMAL to INT
    -- date_2017_10: from DECIMAL to INT
    -- date_2017_11: from DECIMAL to INT
    -- date_2017_12: from DECIMAL to INT
    -- date_2018_01: from DECIMAL to INT
    -- date_2018_02: from DECIMAL to INT
    -- date_2018_03: from DECIMAL to INT
    -- date_2018_04: from DECIMAL to INT
    -- date_2018_05: from DECIMAL to INT
    -- date_2018_06: from DECIMAL to INT
    -- date_2018_07: from DECIMAL to INT
    -- date_2018_08: from DECIMAL to INT
    -- date_2018_09: from DECIMAL to INT
    SELECT
        "Area",
        "Borough",
        "AreaType",
        ...
        "date_2017_02",
        "date_2017_03",
        CAST("date_2017_04" AS INT) 
        AS "date_2017_04",
        CAST("date_2017_05" AS INT) 
        AS "date_2017_05",
        CAST("date_2017_06" AS INT) 
        AS "date_2017_06",
        CAST("date_2017_07" AS INT) 
        AS "date_2017_07",
        CAST("date_2017_08" AS INT) 
        AS "date_2017_08",
        CAST("date_2017_09" AS INT) 
        AS "date_2017_09",
        CAST("date_2017_10" AS INT) 
        AS "date_2017_10",
        CAST("date_2017_11" AS INT) 
        AS "date_2017_11",
        CAST("date_2017_12" AS INT) 
        AS "date_2017_12",
        CAST("date_2018_01" AS INT) 
        AS "date_2018_01",
        CAST("date_2018_02" AS INT) 
        AS "date_2018_02",
        CAST("date_2018_03" AS INT) 
        AS "date_2018_03",
        CAST("date_2018_04" AS INT) 
        AS "date_2018_04",
        CAST("date_2018_05" AS INT) 
        AS "date_2018_05",
        CAST("date_2018_06" AS INT) 
        AS "date_2018_06",
        CAST("date_2018_07" AS INT) 
        AS "date_2018_07",
        CAST("date_2018_08" AS INT) 
        AS "date_2018_08",
        CAST("date_2018_09" AS INT) 
        AS "date_2018_09"
    FROM "C1_totalInventory_Coop_renamed"
)

-- COCOON BLOCK END
SELECT *
FROM "C1_totalInventory_Coop_renamed_casted"