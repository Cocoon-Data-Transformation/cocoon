...
-- Generated at 2024-07-22 18:19:07.138589+00:00
WITH 
"G3_discountShare_OneBd_renamed" AS (
    ...
    FROM "memory"."main"."G3_discountShare_OneBd"
)

-- COCOON BLOCK END
SELECT *
FROM "G3_discountShare_OneBd_renamed"